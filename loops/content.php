...
If you require only post excerpts to be shown in doing a you you index and category pages, then use the [---more---] line within blog posts.
    ...
    <article role="article" id="post_<?php the_ID()?>" class="articleBlogs">
      <?php the_post_thumbnail(); ?>
        ...
        <header class="headingsBlogs">
            <h3 class="blogsHeading"><a href="<?php the_permalink(); ?>"><?php the_title()?></a></h3>
            <h5 class="blogInfos">
              <em>
        ...
        <section>
            ...
            <?php the_excerpt( __( '&hellip; ' . __('Continue reading', 'b4st' ) . ' <i class="fa fa-arrow-right"></i>', 'b4st' ) ); ?>
        </section>
