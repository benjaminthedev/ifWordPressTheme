<?php
/*
Template Name: Disablement Insurance Quote Page
*/
 ...
 <div class="container-fluid">
   <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
              ...
              <div class="image-hero animated fadeInLeft newImageAnimate ">
                <img src="<?php the_field('image_of_man'); ?>" class="man-hero-left"/>
              </div>
        ...
        <div class="white-box-hero col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-md-2   offset-lg-2  ">
...
<div class="custom-logos">
 ...
 <!-- Logo Sections End -->
   ...
   <div class="blue-background-Inverse">
